...
export default function SawalJawabPage() {
  ...
  const questions = [
    {
      id: 1,
      title: "What are the legal requirements for starting a business in India?",
      description:
    ...
    },
    {
      ...
      description: "My neighbor has encroached on my property boundary. What legal action can I take?",
      author: "Priya Patel",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Sawal Jawab</h1>
              <p className="text-gray-600">Ask legal questions and get answers from experts and community</p>
            </div>
            <Button onClick={() => setShowQuestionForm(!showQuestionForm)} className="mt-4 md:mt-0">
              ...
              {showQuestionForm && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Get help from legal experts and community members</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <Input placeholder="Question title" />
                    <Textarea placeholder="Describe your legal question in detail..." rows={4} />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    {["Property Law", "Business Law", "Family Law", "Criminal Law", "Employment Law", "Tax Law"].map(
                      (category) => (
                        <div
                          key={category}
                    ...
                    {[
                      ...
                      <div key={index} className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-gray-500">{contributor.answers} answers</div>
                        </div>
                      </div>
                    ))}
                  </div>
