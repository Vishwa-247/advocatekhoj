  ...
  const deletedCases = [
    {
      ...
      description: "Issue with employment contract terms and wrongful termination. Case was resolved successfully.",
      responses: 3,
    },
  ]
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your legal cases and connect with advocates</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="cases" className="space-y-6">
          ...
          <Tabs defaultValue="live" className="space-y-4">
            <TabsList>
              <TabsTrigger value="live">Live Cases ({liveCases.length})</TabsTrigger>
              <TabsTrigger value="deleted">Deleted Cases ({deletedCases.length})</TabsTrigger>
            </TabsList>
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-muted-foreground text-center mb-4">
                      You haven't posted any cases yet. Start by posting your first legal case.
                    </p>
                    <Button onClick={() => setShowPostCase(true)}>
                      <Plus className="h-4 w-4 mr-2" />
              ...
              {deletedCases.length > 0 ? (
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <h3 className="text-lg font-semibold mb-2">No deleted cases</h3>
                    <p className="text-muted-foreground text-center">
                      Cases you delete will appear here and can be restored if needed.
                    </p>
                  </CardContent>
                </Card>
              )}
