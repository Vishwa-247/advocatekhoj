...
export default function LawCollegesPage() {
  ...
  return (
    <PageLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 overflow-x-hidden">

        {/* Redirecting Header row like Law Library */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
          ...
          <Link
            href="/contact-us?context=submit-law-college"
