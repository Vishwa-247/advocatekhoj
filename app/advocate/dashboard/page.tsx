...
import { User, FileText, CreditCard, MessageSquare, TrendingUp, Star, Calendar, DollarSign, Eye } from "lucide-react"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Based on {stats.reviews} reviews</p>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Enjoy unlimited case responses and priority listing</p>
                </div>
                <Button variant="outline" onClick={() => setActiveTab("membership")}>
                  Manage Plan
                </Button>
              </div>
            </CardContent>
